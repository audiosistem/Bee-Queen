...
from modules.kodi_utils import hide_busy_dialog, notification, show_busy_dialog
...
def debrid_enabled():
	return [i[0] for i in [("Real-Debrid", "rd"), ("Premiumize.me", "pm"), ("AllDebrid", "ad"), ("TorBox", "tb")] if enabled_debrids_check(i[1])]
