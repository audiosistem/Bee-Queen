...
from modules.kodi_utils import build_url, close_all_dialog, execute_builtin, external, kodi_dialog, kodi_refresh, notification, select_dialog
...
def get_key_id(params):
	...
	if search_type == "media_title":
		if media_type == "movie":
			...
			url_params, string = {"mode": "build_tvshow_list", "action": "tmdb_tv_search", "is_anime_list": "false"}, "tvshow_queries"
		elif media_type == "anime":
			url_params, string = {"mode": "build_tvshow_list", "action": "tmdb_tv_search", "is_anime_list": "true"}, "anime_queries"
		else:
			url_params, string = {"mode": "build_tvshow_list", "action": "tmdb_tv_search"}, "tvshow_anime_queries"  # media_type=tvshow_anime
