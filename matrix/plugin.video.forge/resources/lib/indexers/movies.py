	...
	def fetch_list(self):
		...
		try:
			...
			if page_no == 1 and not self.is_external:
				kodi_utils.set_property("forge.exit_params", kodi_utils.folder_path())
			...
			set_properties(
				{
					...
					"forge.extras_params": extras_params,
					"forge.options_params": options_params,
					"forge.playback_options_params": playback_options_params,
					"forge.browse_movie_set_params": browse_movie_set_params,
					"forge.browse_recommended_params": browse_recommended_params,
					"forge.browse_related_params": browse_related_params,
					"forge.browse_more_like_this_params": browse_more_like_this_params,
					"forge.browse_in_trakt_list_params": browse_in_trakt_list_params,
					"forge.trakt_manager_params": trakt_manager_params,
					"forge.personal_manager_params": personal_manager_params,
					"forge.tmdb_manager_params": tmdb_manager_params,
					"forge.favorites_manager_params": favorites_manager_params,
					"forge.quick_add_params": quick_add_params,
				}
			)
