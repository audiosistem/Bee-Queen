...
class EasyNewsAPI:
	def __init__(self):
		...
		self.username = get_setting("forge.easynews.username", "empty_setting")
		self.password = get_setting("forge.easynews.password", "empty_setting")
	...
	def _auth_failed(self):
		...
		if get_property("forge.easynews.auth_failed") == "true":
			return
		set_property("forge.easynews.auth_failed", "true")
	...
	def _auth_ok(self):
		...
		if get_property("forge.easynews.auth_failed") == "true":
			clear_property("forge.easynews.auth_failed")
