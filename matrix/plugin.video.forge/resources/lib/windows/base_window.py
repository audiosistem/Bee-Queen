...
def window_manager(obj):
	def close():
		obj.close()
		kodi_utils.clear_property("forge.window_loaded")
		kodi_utils.clear_property("forge.window_stack")

	def monitor():
		timer = 0
		while not kodi_utils.get_property("forge.window_loaded") == "true" and timer <= 5:
			kodi_utils.sleep(50)
			timer += 0.05
	...
	def add_to_stack(params):
		...
		kodi_utils.set_property("forge.window_stack", json.dumps(window_stack))
...
class BaseDialog(xbmcgui.WindowXMLDialog):
	...
	def set_home_property(self, prop, value):
		kodi_utils.set_property("forge.%s" % prop, value)

	def get_home_property(self, prop):
		return kodi_utils.get_property("forge.%s" % prop)

	def clear_home_property(self, prop):
		return kodi_utils.clear_property("forge.%s" % prop)
...
class FontUtils:
	def execute_custom_fonts(self, skin_files=[]):
		...
		if not skin_files:
			kodi_utils.set_property("forge.current_skin", self.current_skin)
			kodi_utils.set_property("forge.current_font", self.current_font)
		skin_files = skin_files or kodi_utils.list_dirs(kodi_utils.translate_path("special://home/addons/plugin.video.forge/resources/skins/Default/1080i/"))[1]
	...
	def skin_change_check(self):
		...
		if self.current_skin != kodi_utils.get_property("forge.current_skin") or self.current_font != kodi_utils.get_property("forge.current_font"):
			return True
		return False

	def match_font(self, size, bold, fallback):
		font_tag = "FORGE_%s%s" % (size, "_BOLD" if bold else "")
	...
	def replace_font(self, window, replacement_values):
		file = kodi_utils.translate_path("special://home/addons/plugin.video.forge/resources/skins/Default/1080i/" + window)
...
class ExtrasUtils:
	...
	def run(self):
		...
		file = kodi_utils.translate_path("special://home/addons/plugin.video.forge/resources/skins/Default/1080i/%s" % skin_file)
				...
				<control type="group">
				    ...
				    <control type="group">
				        ...
				        <control type="fixedlist" id="{container_no}">
				            ...
				            <itemlayout height="360" width="236">
				                <control type="image">
				                    ...
				                    <texture diffuse="forge_diffuse/poster-50.png" background="true">$INFO[ListItem.Property(thumbnail)]</texture>
				                </control>
				            </itemlayout>
				            <focusedlayout height="360" width="236">
				                <control type="image">
				                    ...
				                    <height>350</height>
				                    <width>236</width>
				                    <texture colordiffuse="FFCCCCCC">forge_diffuse/poster-50.png</texture>
				        ...
				        <control type="scrollbar" id="{scrollbar_no}">
				            ...
				            <texturesliderbackground colordiffuse="FF1F2020">forge_common/white.png</texturesliderbackground>
				            <texturesliderbar colordiffuse="FF555556">forge_common/white.png</texturesliderbar>
				            <texturesliderbarfocus colordiffuse="FFCCCCCC">forge_common/white.png</texturesliderbarfocus>
				        ...
				        <control type="image">
				            ...
				            <width>25</width>
				            <height>25</height>
				            <texture colordiffuse="CCCCCCCC" background="true">forge_common/arrow_left.png</texture>
				        ...
				        <control type="image">
				            ...
				            <width>25</width>
				            <height>25</height>
				            <texture colordiffuse="CCCCCCCC" background="true" flipx="true">forge_common/arrow_left.png</texture>
				        ...
				        <control type="panel" id="{container_no}">
				            ...
				            <itemlayout height="380" width="590">
				                <control type="image">
				                    <height>360</height>
				                    <width>580</width>
				                    <texture colordiffuse="$INFO[Window(10000).Property(forge.window_theme.extras)]" border="30">forge_common/circle.png</texture>
				                </control>
				            ...
				            <focusedlayout height="380" width="590">
				                <control type="image">
				                    <height>360</height>
				                    <width>580</width>
				                    <texture colordiffuse="FFCCCCCC" border="30">forge_common/circle.png</texture>
				                </control>
				                <control type="textbox">
				                    <top>15</top>
				                    <left>20</left>
                ...
                <control type="group">
                    ...
                    <control type="group">
                        ...
                        <control type="button" id="{container_no}">
                            ...
                            <onup>{p_container_no}</onup>
                            <ondown>{n_container_no}</ondown>
                            <texturefocus colordiffuse="FFCCCCCC" border="30">forge_common/circle.png</texturefocus>
                            <texturenofocus colordiffuse="$INFO[Window(10000).Property(forge.window_theme.extras)]" border="30">forge_common/circle.png</texturenofocus>
                        </control>
                        <control type="textbox">
                            <top>65</top>
                            <left>15</left>
...
<window>
    ...
    <controls>
        <control type="group">
            ...
            <height>1080</height>
            <control type="image">
                <texture colordiffuse="FF000000">forge_common/white.png</texture>
            </control>
        ...
        <control type="group">
            ...
            <control type="group">
                ...
                <control type="image">
                    ...
                    <texture>$INFO[Window(10000).Property(forge.addon_icon_mini)]</texture>
                </control>
                <control type="group">
                ...
                <control type="group">
                    ...
                    <control type="image">
                        ...
                        <height>35</height>
                        <aspectratio>keep</aspectratio>
                        <texture>forge_common/info.png</texture>
                        <visible>!String.IsEqual(ListItem.Property(info_alert),)</visible>
                    </control>
                    <control type="label">
            ...
            <control type="group">
                <control type="image" id="200">
                    ...
                    <height>1000</height>
                    <aspectratio>keep</aspectratio>
                    <texture diffuse="forge_diffuse/poster-50.png" background="true" />
                </control>
                <control type="group">
                    ...
                    <control type="label">
                        ...
                        <height>30</height>
                        <font>font60</font> <!-- FORGE_60_BOLD -->
                        <textcolor>FFCCCCCC</textcolor>
                        <align>center</align>
                        <aligny>bottom</aligny>
                ...
                <control type="group">
                    ...
                    <control type="group">
                        ...
                        <control type="button" id="15">
                            ...
                            <focusedcolor>FF1F2020</focusedcolor>
                            <texturefocus colordiffuse="FFCCCCCC" border="30">forge_common/circle.png</texturefocus>
                            <texturenofocus colordiffuse="$INFO[Window(10000).Property(forge.window_theme.extras)]" border="30">forge_common/circle.png</texturenofocus>                         <align>center</align>
                            <aligny>center</aligny>
                        </control>
                    ...
                    <control type="group">
                        ...
                        <control type="group">
                            ...
                            <control type="image">
                                ...
                                <height>348</height>
                                <aspectratio>keep</aspectratio>
                                <texture diffuse="forge_diffuse/poster-50.png" background="true">$INFO[Window.Property(more_from_collection.poster)]</texture>
                            </control>
                            <control type="textbox">
                                <left>235</left>
                                <top>6</top>
                        ...
                        <control type="fixedlist" id="{container_no}">
                            ...
                            <itemlayout height="360" width="392">
                                <control type="image">
                                    ...
                                    <aspectratio>keep</aspectratio>
                                    <texture diffuse="forge_diffuse/landscape.png" background="true">$INFO[ListItem.Property(thumbnail)]</texture>
                                </control>
                            </itemlayout>
                            <focusedlayout height="360" width="392">
                                <control type="image">
                                    ...
                                    <height>296</height>
                                    <width>393</width>
                                    <texture colordiffuse="FFCCCCCC">forge_diffuse/landscape.png</texture>
                                    <visible>Control.HasFocus({container_no}) | Control.HasFocus({scrollbar_no})</visible>
                                </control>
                                <control type="image">
                                    <left>8</left>
                        ...
                        <control type="fixedlist" id="{container_no}">
                            ...
                            <itemlayout height="360" width="236">
                                ...
                                <control type="image">
                                    ...
                                    <width>50</width>
                                    <aspectratio>keep</aspectratio>
                                    <texture colordiffuse="red">forge_common/overlay_selected.png</texture>
