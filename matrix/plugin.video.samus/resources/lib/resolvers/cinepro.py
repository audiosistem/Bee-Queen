...
_BASE_URL = 'https://cinepro-addon.onrender.com'
_LABEL = '[CPR]'
...
def get_sources(imdb_id, media_type='movie', season=None, episode=None):
    try:
        ...
        xbmc.log(f'[Samus/CinePro] {len(results)} surse pentru imdb_id={imdb_id}', xbmc.LOGINFO)
        return results
    except Exception as e:
        xbmc.log(f'[Samus/CinePro] {e}', xbmc.LOGERROR)
        return []
