...
_BASE_URL = 'https://nuviostreams.hayd.uk'
_LABEL = '[NUV]'
...
def get_sources(imdb_id, media_type='movie', season=None, episode=None):
    try:
        ...
        xbmc.log(f'[Samus/Nuvio] {len(results)} surse pentru imdb_id={imdb_id}', xbmc.LOGINFO)
        return results
    except Exception as e:
        xbmc.log(f'[Samus/Nuvio] {e}', xbmc.LOGERROR)
        return []
