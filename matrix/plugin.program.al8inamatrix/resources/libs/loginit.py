...
ORDER = ['easynews-fen',
         'fanart-alvin', 'fanart-gaia', 'fanart-nightwing',
         'fanart-metadatautils', 'fanart-premiumizer', 'fanart-realizer',
         'fanart-scrubs', 'fanart-seren', 'fanart-thepromise', 'fanart-tmdbhelper',
         'fanart-homelander',
         'furk-fen',
         'imdb-alvin', 'imdb-gaia', 'imdb-nightwing', 'imdb-premiumizer',
         'imdb-realizer', 'imdb-scrubs', 'imdb-thepromise', 'imdb-homelander',
         'kitsu-wonderfulsubs',
         ...
         'login-eis', 'tmdb-gaia',
         'tmdb-alvin', 'tmdb-fen', 'tmdb-metadatautils', 'tmdb-nightwing',
         'tmdb-openinfo', 'tmdb-openmeta', 'tmdb-premiumizer', 'tmdb-realizer',
         'tmdb-scrubs', 'tmdb-seren', 'tmdb-thepromise', 'tmdb-tmdbhelper',
         'tmdb-homelander',
...
LOGINID = {
    ...
    'tmdb-alvin': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.alvin', 'icon.gif'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.alvin', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'alvin_tmdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.alvin', 'settings.xml'),
        'default'  : 'tm.user',
        'data'     : ['tm.user'],
        'activate' : ''},
    'imdb-alvin': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.alvin', 'icon.gif'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.alvin', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'alvin_imdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.alvin', 'settings.xml'),
        'default'  : 'imdb.user',
        'data'     : ['imdb.user'],
        'activate' : ''},
    'fanart-homelander': {
        'name'     : 'Fanart.tv - Homelander',
        'plugin'   : 'plugin.video.homelander',
        'saved'    : 'fanart-homelander',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.homelander'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.homelander', 'icon.gif'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.homelander', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'homelander_fanart'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.homelander', 'settings.xml'),
        'default'  : 'fanart.tv.user',
        'data'     : ['fanart.tv.user'],
        'activate' : ''},
    'tmdb-homelander': {
        'name'     : 'TMDb - Homelander',
        'plugin'   : 'plugin.video.homelander',
        'saved'    : 'tmdb-homelander',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.homelander'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.homelander', 'icon.gif'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.homelander', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'homelander_tmdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.homelander', 'settings.xml'),
        'default'  : 'tm.user',
        'data'     : ['tm.user'],
        'activate' : ''},
    'imdb-homelander': {
        'name'     : 'IMDb - Homelander',
        'plugin'   : 'plugin.video.homelander',
        'saved'    : 'imdb-homelander',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.homelander'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.homelander', 'icon.gif'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.homelander', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'homelander_imdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.homelander', 'settings.xml'),
        'default'  : 'imdb.user',
        'data'     : ['imdb.user'],
        'activate' : ''},
    'fanart-nightwing': {
        'name'     : 'Fanart.tv - Nightwing',
        'plugin'   : 'plugin.video.nightwing',
        'saved'    : 'fanart-nightwing',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.nightwing'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.nightwing', 'icon.gif'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.nightwing', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'nightwing_fanart'),
    ...
    'tmdb-nightwing': {
        'name'     : 'TMDb - Nightwing',
        'plugin'   : 'plugin.video.nightwing',
        'saved'    : 'tmdb-nightwing',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.nightwing'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.nightwing', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.nightwing', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'nightwing_tmdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.nightwing', 'settings.xml'),
        'default'  : 'tm.user',
        'data'     : ['tm.user'],
        'activate' : ''},
    'imdb-nightwing': {
        'name'     : 'IMDb - Nightwing',
        'plugin'   : 'plugin.video.nightwing',
        'saved'    : 'imdb-nightwing',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.nightwing'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.nightwing', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.nightwing', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'nightwing_imdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.nightwing', 'settings.xml'),
        'default'  : 'imdb.user',
        'data'     : ['imdb.user'],
        'activate' : ''},        
    'fanart-thepromise': {
        'name'     : 'Fanart.tv - THE PROMISE',
        'plugin'   : 'plugin.video.thepromise',
        'saved'    : 'fanart-thepromise',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.thepromise'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.thepromise', 'icon.gif'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.thepromise', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'thepromise_fanart'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.thepromise', 'settings.xml'),
        'default'  : 'fanart.tv.user',
        'data'     : ['fanart.tv.user'],
        'activate' : ''},
    'tmdb-thepromise': {
        'name'     : 'TMDb - THE PROMISE',
        'plugin'   : 'plugin.video.thepromise',
        'saved'    : 'tmdb-thepromise',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.thepromise'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.thepromise', 'icon.gif'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.thepromise', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'thepromise_tmdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.thepromise', 'settings.xml'),
        'default'  : 'tm.user',
        'data'     : ['tm.user'],
        'activate' : ''},
    'imdb-thepromise': {
        'name'     : 'IMDb - THE PROMISE',
        'plugin'   : 'plugin.video.thepromise',
        'saved'    : 'imdb-thepromise',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.thepromise'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.thepromise', 'icon.gif'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.thepromise', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'thepromise_imdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.thepromise', 'settings.xml'),
        'default'  : 'imdb.user',
        'data'     : ['imdb.user'],
        'activate' : ''},
    ...
    'fanart-scrubs': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.scrubsv2', 'resources/images/icon.gif'),
    ...
    'login-youtube': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.youtube', 'resources/media/icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.youtube', 'resources/media/fanart.jpg'),
