...
ORDER = ['umbrella', 'fen', 'elementum', 'romanianpack', 'fen', 'openmeta', 'premiumizer',
         'realizer', 'seren', 'shadow', 'asgard', 'trakt', 'scrubsv2']
...
TRAKTID = {
    'umbrella': {
        ...
        'data'     : ['trakt.user.token', 'trakt.user.name', 'trakt.token.expires', 'trakt.refreshtoken'],
        'activate' : 'RunPlugin(plugin://plugin.video.umbrella/?action=authTrakt)'},
    'elementum': {
        'name'     : 'Elementum',
        'plugin'   : 'plugin.video.elementum',
        'saved'    : 'elementum',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.elementum'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.elementum', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.elementum', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.TRAKTFOLD, 'elementum_trakt'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.elementum', 'settings.xml'),
        'default'  : 'trakt.user',
        'data'     : ['trakt.auth', 'trakt.refresh', 'trakt.username'],
        'activate' : 'RunPlugin(plugin://plugin.video.elementum/?action=authTrakt)'},
    'romanianpack': {
        'name'     : 'MRSP',
        'plugin'   : 'plugin.video.romanianpack',
        'saved'    : 'romanianpack',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.romanianpack'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.romanianpack', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.romanianpack', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.TRAKTFOLD, 'romanianpack_trakt'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.romanianpack', 'settings.xml'),
        'default'  : 'trakt.user',
        'data'     : ['autorizare', 'trakt.refresh', 'trakt.user'],
        'activate' : 'RunPlugin(plugin://plugin.video.romanianpack/?action=authTrakt)'},
    'fen': {
        'name'     : 'Fen',
        ...
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.fen', 'resources/media/fen_fanart.jpg'),
        'file'     : os.path.join(CONFIG.TRAKTFOLD, 'fen_trakt'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.fen', 'settings.xml'),
        'default'  : 'trakt.user',
        'data'     : ['accounts.manager.trakt', 'trakt.refresh', 'trakt.user'],
    ...
    'asgard': {
        ...
        'default'  : 'trakt.user',
        'data'     : ['trakt.auth', 'trakt.refresh', 'trakt.username'],
        'activate' : 'RunPlugin(plugin://plugin.video.asgard/?action=authTrakt)'},
    'seren': {
        'name'     : 'Seren',
