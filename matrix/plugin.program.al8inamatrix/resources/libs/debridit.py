...
ORDER = ['fenad', 'fenpm', 'fenrd',
         'asgardad', 'asgardrd', 'asgardpm',
         'pmzer',
         'umbrellaad', 'umbrellapm', 'umbrellapm-oauth', 'umbrellard', 
...
DEBRIDID = {
    'asgardad': {
        ...
        'file': os.path.join(CONFIG.DEBRIDFOLD, 'asgard_alldebrid'),
        ...
        'activate': 'RunPlugin(plugin://plugin.video.asgard/?action=allDebridSettings)'},
    'asgardrd': {
        'name'     : 'asgard RD',
        'plugin'   : 'plugin.video.asgard',
        'saved'    : 'asgardrd',
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.asgard', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.asgard', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'asgard_debrid'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.asgard', 'settings.xml'),
        ...
        'activate' : 'RunPlugin(plugin://plugin.video.asgard/?action=realdebridAuthentication)'},
    'asgardpm': {
        'name'     : 'asgard PM',
        'plugin'   : 'plugin.video.asgard',
        'saved'    : 'asgardpm',
        ...
        'activate' : 'RunPlugin(plugin://plugin.video.asgard/?action=premiumizeSettings)'},
    'umbrellaad': {
        'name'     : 'umbrella AD',
        ...
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'umbrella_ad'),
        ...
        'activate' : 'RunPlugin(plugin.video.umbrella/?action=openSettings)'},
    'umbrellard': {
        'name'     : 'umbrella RD',
        'plugin'   : 'plugin.video.umbrella',
        'saved'    : 'umbrellard',
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.umbrella', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.umbrella', 'fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'umbrella_rd'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.umbrella', 'settings.xml'),
        'default'  : 'rd.username',
        'data'     : [ 'rd.auth', 'rd.client_id', 'rd.expiry', 'rd.refresh', 'rd.secret', 'rd.username', 'realdebrid.enabled'],
        'activate' : 'RunPlugin(plugin://plugin.video.umbrella/?action=authRealDebrid)'},
    'umbrellapm': {
        'name'     : 'umbrella PM (API Key)',
        'plugin'   : 'plugin.video.umbrella',
        'saved'    : 'umbrellapm',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.umbrella'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.umbrella', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.umbrella', 'fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'umbrella_pm'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.umbrella', 'settings.xml'),
        'default'  : 'premiumize.pin',
        'data'     : ['premiumize.enabled', 'premiumize.pin'],
        'activate' : 'RunPlugin(plugin.video.umbrella/?action=openSettings)'},
    'umbrellapm-oauth': {
        'name'     : 'umbrella PM (OAuth)',
        'plugin'   : 'plugin.video.umbrella',
        'saved'    : 'umbrellapm-oauth',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.umbrella'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.umbrella', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.umbrella', 'fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'umbrella_pmoauth'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.umbrella', 'settings.xml'),
