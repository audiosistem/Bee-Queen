...
from viperscrapers.modules.control import existsPath, dataPath, makeFile, undesirablescacheFile, lang
...
class Undesirables():
	...
	def set_defaults(self):
		from viperscrapers.modules.source_utils import UNDESIRABLES
...
def undesirablesSelect():
	from viperscrapers.modules.control import multiselectDialog
	from viperscrapers.modules.source_utils import UNDESIRABLES
...
def undesirablesUserRemove():
	from viperscrapers.modules.control import multiselectDialog, notification
	undesirables_cache = Undesirables()
...
def undesirablesUserRemoveAll():
	from viperscrapers.modules.control import yesnoDialog, notification
	undesirables_cache = Undesirables()
	user_undesirables = undesirables_cache.get_user_defined()
	if not user_undesirables: return notification(message=32084)
...
def undesirablesInput():
	from viperscrapers.modules.control import dialog
	undesirables_cache = Undesirables()
