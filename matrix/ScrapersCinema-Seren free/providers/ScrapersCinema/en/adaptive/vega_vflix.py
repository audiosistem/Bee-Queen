...
class sources():
    def __init__(self):
        ...
        self.base_url = "https://vega.vflix.life"
    ...
    def _process_item(self, item_url, simple_info):
        ...
        try:
            ...
            for stream in streams:
                ...
                # --- Provider Display ---
                # Curățăm numele pentru a evidenția sursa de debrid (RD, PM, etc)
                p_display = raw_name.replace("WebStreamr", "").replace("Vega", "").strip()
                if not p_display: p_display = "VEGA"
