...
class Button(CompareMixin, xbmcgui.ControlButton):
    ...
    :param angle: angle of control. (``+`` rotates CCW, ``-`` rotates CW)
    :type angle: int
    :param shadowColor: hex color code of button's label's The Chains. (e.g. ``'0xFF000000'``)
...
class RadioButton(CompareMixin, xbmcgui.ControlRadioButton):
    ...
    :param angle: angle of control. (+ rotates CCW, - rotates CW)
    :type angle: int
    :param shadowColor: hexstring -- color of radio button's label's The Chains. (e.g. '0xFF000000')
    :type shadowColor: str
