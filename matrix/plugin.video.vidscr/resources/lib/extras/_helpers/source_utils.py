...
# Optional anime-genre lookup hits trakt; we don't need it in vidscr,
# so the function below returns False unconditionally.
trakt = None
...
def is_anime(content, type, type_id):
    try:
        return False  # trakt not wired in this build
