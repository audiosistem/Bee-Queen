...
from gearsscrapers.modules.control import existsPath, dataPath, makeFile, undesirablescacheFile, lang
...
class Undesirables():
	...
	def set_defaults(self):
		from gearsscrapers.modules.source_utils import UNDESIRABLES
...
def undesirablesSelect():
	from gearsscrapers.modules.control import multiselectDialog
	from gearsscrapers.modules.source_utils import UNDESIRABLES
...
def undesirablesUserRemove():
	from gearsscrapers.modules.control import multiselectDialog, notification
	undesirables_cache = Undesirables()
...
def undesirablesUserRemoveAll():
	from gearsscrapers.modules.control import yesnoDialog, notification
	undesirables_cache = Undesirables()
	user_undesirables = undesirables_cache.get_user_defined()
	if not user_undesirables: return notification(message='No User Undesirables Set')
...
def undesirablesInput():
	from gearsscrapers.modules.control import dialog
	undesirables_cache = Undesirables()
