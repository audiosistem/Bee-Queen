...
__config_PVRIPTVSimpleClientIntegration_FilterType__ = ''
...
__digionline_API_userAgent__ = 'okhttp/4.11.0'
...
__voyo_API_userAgent__ = 'Voyo/6.10.4 (net.cme.voyo.ro; build:3243; Android 9; Model:Android) okhttp/4.10.0'
...
__voyo_StateFilename__ = 'voyo.ro_State.txt'
...
__PVRIPTVSimpleClientIntegration__ChannelFilter_map__ = {}
__PVRIPTVSimpleClientIntegration__ChannelFilter_map__['0'] = "None"
__PVRIPTVSimpleClientIntegration__ChannelFilter_map__['1'] = "Blacklist"
__PVRIPTVSimpleClientIntegration__ChannelFilter_map__['2'] = "Whitelist"

# File name for the file containnig Black/White listed channels
__PVRIPTVSimpleClientIntegration__ChannelFilter_Lists_FileName__ = 'filter_lists.json'
...
# Some Voyo constants
__voyo_x_devicetype__ = 'mobile'
__voyo_x_devicesubtype__ = 'smartphone'
__voyo_x_devicemanufacturer__ = 'Google'
__voyo_x_devicemodel__ = 'Pixel 4'
__voyo_x_deviceos__ = 'Android'
__voyo_x_deviceosversion__ = '28'
__voyo_x_version__ = '6.10.4'
__voyo_x_app_appbuildnumber__ = '3243'
__voyo_x_devicename__ = 'Kodi'


# Some other strings
__digionline_TV_API_client_i__ = 'dHZfYW5kcm9pZA=='
__digionline_TV_API_client_s__ = 'OThIZEVFZjJBSVR5Y2RVWg=='
