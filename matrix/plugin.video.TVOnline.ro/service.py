...
def PVRIPTVSimpleClientIntegration_update_m3u_file():
  ...
  if common_functions.has_accounts_enabled() == 'true':
    ...
    if common_vars.__config_voyo_Enabled__ == 'true':
      _current_channel_number_ = voyo_functions.voyo__PVRIPTVSimpleClientIntegration_update_m3u_file(_tmp_m3u_file_, _current_channel_number_, common_vars.__ServiceID__, common_vars.__voyo_CookieJar__, common_vars.__voyo_ServiceSession__, MyServiceAddon_DataDir)

    common_vars.__logger__.debug('_current_channel_number_ = ' + str(_current_channel_number_))

    # primaplay.ro
    if common_vars.__config_primaplay_Enabled__ == 'true':
      _current_channel_number_ = primaplay_functions.PVRIPTVSimpleClientIntegration_update_m3u_file(_tmp_m3u_file_, _current_channel_number_, common_vars.__ServiceID__, common_vars.__primaplay_CookieJar__, common_vars.__primaplay_ServiceSession__, MyServiceAddon_DataDir)

    common_vars.__logger__.debug('_current_channel_number_ = ' + str(_current_channel_number_))

    # tvrplus.ro
    if common_vars.__config_tvrplus_Enabled__ == 'true':
      _current_channel_number_ = tvrplus_functions.PVRIPTVSimpleClientIntegration_update_m3u_file(_tmp_m3u_file_, _current_channel_number_, common_vars.__ServiceID__, common_vars.__tvrplus_CookieJar__, common_vars.__tvrplus_ServiceSession__, MyServiceAddon_DataDir)
...
def PVRIPTVSimpleClientIntegration_update_EPG_file():
  ...
  if common_functions.has_accounts_enabled() == 'true':
    ...
    if common_vars.__config_voyo_Enabled__ == 'true':
      voyo_functions.voyo__PVRIPTVSimpleClientIntegration_update_EPG_file(_tmp_epg_file_, common_vars.__ServiceID__, common_vars.__voyo_CookieJar__, common_vars.__voyo_ServiceSession__, MyServiceAddon_DataDir)
...
if __name__ == '__main__':
  ...
  common_vars.__logger__.debug('Waiting 120 seconds for network to stabilize')
  time.sleep(120)
  common_vars.__logger__.debug('Done waiting 120 seconds for network to stabilize')
