...
DISCOVERY_ENABLED = (control.condVisibility('System.HasAddon(slyguy.discovery.plus)') and control.setting('discovery.plus') == 'true')
...
SCRAPER_INIT = any(e for e in [NETFLIX_ENABLED, PRIME_ENABLED, HBO_ENABLED, MAX_ENABLED, DISNEY_ENABLED, IPLAYER_ENABLED, CURSTREAM_ENABLED, HULU_ENABLED, ITV_ENABLED,
                               PARAMOUNT_ENABLED, CRACKLE_ENABLED, TUBI_ENABLED, UKTVPLAY_ENABLED, PLUTO_ENABLED, DISCOVERY_ENABLED])
...
def enabled_services():
    services = [
        ...
        ('Discovery+', '404|406|510|520|524|1836', DISCOVERY_ENABLED),
        ('Disney+', '337|390', DISNEY_ENABLED),
        ('HBO Max', '118|244|616|384|27|425|31', HBO_ENABLED),
        ('Hulu', '15', HULU_ENABLED),
        ('ITV Hub', '41', ITV_ENABLED),
        ('MAX', '118|244|616|384|27|425|31|1899', MAX_ENABLED),
        ('Netflix', '8|175|1796', NETFLIX_ENABLED),
        ('Paramount+', '531', PARAMOUNT_ENABLED),
        ('Pluto TV', '300', PLUTO_ENABLED),
        ('Prime Video', '9|10|119|613', PRIME_ENABLED),
