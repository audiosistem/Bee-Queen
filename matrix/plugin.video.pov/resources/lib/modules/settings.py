...
def metadata_user_info():
	...
	return {
		...
		'rpdb_api_key': rpdb_api, 'rpdb_theme': rpdb_theme, 'extra_rpdb_movies': extra_rpdb_movies, 'extra_rpdb_series': extra_rpdb_series
	}
...
default_internal_scrapers, cloud_scrapers = (
	'ad_cloud', 'pm_cloud', 'rd_cloud', 'tb_cloud', 'oc_cloud', 'torboxnews', 'easynews', 'folders'
