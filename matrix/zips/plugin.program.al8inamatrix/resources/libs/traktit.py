...
ORDER = ['alvin', 'fen', 'elementum', 'romanianpack', 'openmeta', 'premiumizer',
         'realizer', 'theoath', 'seren', 'shadow', 'thepromise', 'trakt', 'scrubsv2']
...
TRAKTID = {
    'elementum': {
        ...
        'default'  : 'accounts.informants.trakt.token',
        'data'     : ['accounts.informants.trakt.user', 'accounts.informants.trakt.refresh', 'accounts.informants.trakt.token'],
        'activate' : 'RunPlugin(plugin://plugin.video.elementum/?action=traktAuthorize)'},
    'romanianpack': {
        'name'     : 'MRSP',
    ...
    'scrubsv2': {
        ...
        'default'  : 'trakt.user',
        'data'     : ['trakt.token', 'trakt.refresh', 'trakt.user'],
        'activate' : 'RunPlugin(plugin://plugin.video.scrubsv2/?action=authTrakt&opensettings=tru&query=10.2)'},
    'thepromise': {
        'name'     : 'The Promise',
    ...
    'theoath': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.theoath', 'icon.jpg'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.theoath', 'fanart.png'),
