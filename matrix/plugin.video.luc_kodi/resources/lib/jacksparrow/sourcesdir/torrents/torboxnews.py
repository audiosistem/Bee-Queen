		...
		for file in files:
			try:
				...
				item = {
					...
					# v1.0.12: Trust TorBox search-api's per-item `cached` field (same pattern as POV/Umbrella).
					# This avoids a redundant /usenet/checkcached round-trip in the orchestration.
