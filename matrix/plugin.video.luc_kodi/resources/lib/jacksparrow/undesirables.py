...
from resources.lib.jacksparrow.control import existsPath, dataPath, makeFile, undesirablescacheFile, lang
...
class Undesirables():
	...
	def set_defaults(self):
		from resources.lib.jacksparrow.source_utils import UNDESIRABLES
...
def undesirablesSelect():
	from resources.lib.jacksparrow.control import multiselectDialog
	from resources.lib.jacksparrow.source_utils import UNDESIRABLES
...
def undesirablesUserRemove():
	from resources.lib.jacksparrow.control import multiselectDialog, notification
	undesirables_cache = Undesirables()
...
def undesirablesUserRemoveAll():
	from resources.lib.jacksparrow.control import yesnoDialog, notification
	undesirables_cache = Undesirables()
	user_undesirables = undesirables_cache.get_user_defined()
	if not user_undesirables: return notification(message=32084)
...
def undesirablesInput():
	from resources.lib.jacksparrow.control import dialog
	undesirables_cache = Undesirables()
