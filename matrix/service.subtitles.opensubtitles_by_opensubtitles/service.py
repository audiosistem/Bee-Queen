...
def Search( item ):
  ...
  try:
        ...
        if py3: xbmc.executebuiltin((u'Notification(%s,%s)' % (__scriptname__ , __language__(32001))))
        else: xbmc.executebuiltin((u'Notification(%s,%s)' % (__scriptname__ , __language__(32001))).encode('utf-8'))
        return
