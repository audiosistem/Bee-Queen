...
def router(_argv):
    ...
    elif action == 'view_previous_redwizard_changelogs':
        from resources.lib.modules import log_utils
        log_utils.previous_redwizard_changelogs()


    elif action == 'view_previous_jewbmx_changelogs':
        from resources.lib.modules import log_utils
        log_utils.previous_jewbmx_changelogs()
