...
class navigator:
    ...
    def tvshows(self):
        ...
        self.addDirectoryItem('TVmaze New Episodes', 'calendar&url=tvmaze_added', 'latest-episodes.png', 'DefaultRecentlyAddedEpisodes.png', queue=True)
        self.addDirectoryItem('TVmaze Calendar', 'calendars', 'calendar.png', 'DefaultRecentlyAddedEpisodes.png')
    ...
    def tools(self):
        ...
        self.addDirectoryItem('What\'s New', 'view_changelog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem('View Previous [COLOR red]The Red Wizard[/COLOR] Changelogs', 'view_previous_redwizard_changelogs', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem('View Previous [COLOR orange]JewBMX[/COLOR] Changelogs', 'view_previous_jewbmx_changelogs', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
