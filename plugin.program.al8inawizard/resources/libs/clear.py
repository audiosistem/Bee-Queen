...
def get_cache_size():
    ...
    dbfiles = [
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.tempest', 'cache.db')),
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.tempest', 'cache.meta.5.db')),
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.tempest', 'cache.providers.13.db')),
        ...
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.romanianpack', 'cache.meta.5.db')),
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.romanianpack', 'cache.providers.13.db')),
    ...
    if CONFIG.INCLUDEVIDEO == 'true':
        ...
        if CONFIG.INCLUDEALL == 'true':
            ...
            if CONFIG.INCLUDETEMPEST == 'true':
                files.append(os.path.join(CONFIG.ADDON_DATA, 'plugin.video.tempest', 'cache.db'))
                files.append(os.path.join(CONFIG.ADDON_DATA, 'plugin.video.tempest', 'meta.5.db'))
                files.append(os.path.join(CONFIG.ADDON_DATA, 'plugin.video.tempest', 'providers.13.db'))
            ...
            if CONFIG.INCLUDEMRSP == 'true':
                ...
                files.append(os.path.join(CONFIG.ADDON_DATA, 'plugin.video.romanianpack', 'meta.5.db'))
                files.append(os.path.join(CONFIG.ADDON_DATA, 'plugin.video.romanianpack', 'providers.13.db'))
...
def clear_cache(over=None):
    ...
    dbfiles = [
        ...
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.gaia', 'meta.db')),
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.tempest', 'cache.db')),
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.tempest', 'meta.5.db')),
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.tempest', 'cache.providers.13.db')),
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.thecrew', 'cache.db')),
        ...
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.venom', 'cache.providers.13.db')),
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.romanianpack', 'cache.db')),
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.romanianpack', 'meta.5.db')),
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.romanianpack', 'cache.providers.13.db')),
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.theoath', 'cache.db')),
...
def toggle_cache(state):
    cachelist = ['includevideo', 'includeall', 'includetempest', 'includegaia', 'includenumbers', 'includescrubs', 'includeseren', 'includethecrew', 'includevenom']
