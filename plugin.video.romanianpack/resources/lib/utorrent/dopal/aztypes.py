...
if py3:
    wrap_url = _wrapobject('URL', str)
    wrap_file = _wrapobject('File', str)
else:
...
if py3:
    wrap_string = _wrapobject('String', str)
else:
...
class AzureusMethods(object):
    ...
    def get_matching_methods(self, name, args):
        ...
        for methodobj in methods:
            ...
            except ArgumentWrapError as error:
