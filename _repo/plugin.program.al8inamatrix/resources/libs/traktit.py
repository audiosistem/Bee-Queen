...
ORDER = ['alvin', 'fen', 'gaia', 'romanianpack', 'openmeta', 'premiumizer',
         'realizer', 'theoath', 'seren', 'shadow', 'thecrew', 'trakt', 'revolution']
...
TRAKTID = {
    ...
    'revolution': {
        ...
        'default'  : 'trakt.user',
        'data'     : ['trakt.token', 'trakt.refresh', 'trakt.user'],
        'activate' : 'RunPlugin(plugin://plugin.video.revolution/?action=authTrakt&opensettings=tru&query=10.2)'},
    'thecrew': {
        'name'     : 'THE CREW',
