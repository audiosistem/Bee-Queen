...
def get_cache_size():
    ...
    dbfiles = [
        ...
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.revolution', 'cache.db')),
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.revolution', 'cache.meta.5.db')),
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.revolution', 'cache.providers.13.db')),
    ...
    if CONFIG.INCLUDEVIDEO == 'true':
        ...
        if CONFIG.INCLUDEALL == 'true':
            ...
            if CONFIG.INCLUDEREVOLUTION == 'true':
                files.append(os.path.join(CONFIG.ADDON_DATA, 'plugin.video.revolution', 'cache.db'))
                files.append(os.path.join(CONFIG.ADDON_DATA, 'plugin.video.revolution', 'meta.5.db'))
                files.append(os.path.join(CONFIG.ADDON_DATA, 'plugin.video.revolution', 'providers.13.db'))
...
def clear_cache(over=None):
    ...
    dbfiles = [
        ...
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.thecrew', 'cache.providers.13.db')),
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.revolution', 'cache.db')),
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.revolution', 'meta.5.db')),
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.revolution', 'cache.providers.13.db')),
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.romanianpack', 'cache.db')),
        (os.path.join(CONFIG.ADDON_DATA, 'plugin.video.theoath', 'cache.db')),
...
def toggle_cache(state):
    cachelist = ['includevideo', 'includeall', 'includealvin', 'includegaia', 'includeromanianpack', 'includetheoath', 'includeseren', 'includethecrew', 'includerevolution']
    titlelist = ['Include Video Addons', 'Include All Addons', 'Include Alvin', 'Include Gaia', 'Include MRSP', 'Include THE OATH', 'Include Seren', 'Include THE CREW', 'Include Revolution']
